...
const navigation = [
    ...
    { name: 'User', href: '/admin/user', current: false },
                        ...
                        <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                            <div className="relative flex h-16 items-center justify-between">
                                ...
                                <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                                    <div className="flex flex-shrink-0 items-center cursor-pointer" onClick={() => goTo('/')} >
                                        <img
                                    ...
                                    <div className="ml-4 flow-root lg:ml-6" onClick={() => setOpen(!open)}>
                                        <a href="#" className="group -m-2 flex items-center p-2">
                                            <ShoppingBagIcon
                                                ...
                                                aria-hidden="true"
                                            />
                                            <span className="ml-2 text-sm font-medium text-gray-300 group-hover:text-white">3</span>
